...
.. code-block:: bash
    ...
    domino --input_path example/dowaNgo.wav --input_phoneme "pau d o w a N g o pau" --output_path result.lab --onnx_path=onnx_model/phoneme_transition_model.onnx --min_frame=3
